...
4. This will generate a video of you in those outfits walking the runway (note: this is currently using luma and viggle's platforms since there's no publicly available API yet)
5. Add an AI-generated music to go along with your walk if you wish!

## Setup

Add your own API keys in .env file for Fal.ai and OpenAI
